...
# create any tables base mapped
Base.metadata.create_all(engine)

# cycle of CRUD operations in python: create connection to db via Session(),
# perform CRUD operation (in this case add_all)
# db.commit() to run insert statements
